package com.rm.lib.daemon.service;
...
import com.rm.lib.daemon.util.DaemonEnv;
...
public class WatchDogService extends Service {
    ...
    protected final int onStart(Intent intent, int flags, int startId) {
        ...
        sDisposable = Observable
                ...
                .subscribe(aLong -> DaemonEnv.startServiceMayBind(DaemonEnv.sServiceClass), Throwable::printStackTrace);
